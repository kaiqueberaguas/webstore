...
{
    public class CategoryService : PagesService<Category>, ICategoryService
    {

        public override string BaseUrl { get; } = "https://localhost:5001/api/v1/category";

        public CategoryService(HttpClient httpClient, ILogger<CategoryService> logger) : base(httpClient, logger)
        {
        }
